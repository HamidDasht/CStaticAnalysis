...
# 1 "../../../coreutils-8.30/lib/ftoastr.h" 1
# 23 "../../../coreutils-8.30/lib/ftoastr.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/float.h" 1 3 4
# 24 "../../../coreutils-8.30/lib/ftoastr.h" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 25 "../../../coreutils-8.30/lib/ftoastr.h" 2
...
# 32 "od.c" 2
# 1 "../../../coreutils-8.30/lib/stat-size.h" 1
# 33 "od.c" 2
# 1 "../../../coreutils-8.30/lib/xbinary-io.h" 1
# 20 "../../../coreutils-8.30/lib/xbinary-io.h"
# 1 "../../../coreutils-8.30/lib/binary-io.h" 1
# 22 "../../../coreutils-8.30/lib/binary-io.h"
# 1 "../../../coreutils-8.30/lib/fcntl.h" 1
# 22 "../../../coreutils-8.30/lib/fcntl.h"
       
# 23 "../../../coreutils-8.30/lib/fcntl.h" 3
# 23 "../../../coreutils-8.30/lib/binary-io.h" 2
...
# 21 "../../../coreutils-8.30/lib/stdio.h" 3
# 27 "../../../coreutils-8.30/lib/binary-io.h" 2
...
inline int
__gl_setmode_check (int fd __attribute__ ((__unused__))) { return 0; }
...
# 21 "../../../coreutils-8.30/lib/xbinary-io.h" 2
...
# 34 "od.c" 2
# 1 "../../../coreutils-8.30/lib/xprintf.h" 1
# 21 "../../../coreutils-8.30/lib/xprintf.h"
# 1 "../../../coreutils-8.30/lib/stdio.h" 1
# 20 "../../../coreutils-8.30/lib/stdio.h"
       
# 21 "../../../coreutils-8.30/lib/stdio.h" 3
# 22 "../../../coreutils-8.30/lib/xprintf.h" 2
                   ...
                   struct tspec *tspec)
{
  ...
  ((tspec != ((void *)0)) ? (void) (0) : __assert_fail ("tspec != NULL", "od.c", 646, __PRETTY_FUNCTION__));
  ...
  switch (*s)
    ...
    case 'x':
      ...
      ((strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED) ? (void) (0) : __assert_fail ("strlen (tspec->fmt_string) < FMT_BYTES_ALLOCATED", "od.c", 745, __PRETTY_FUNCTION__));
...
{
  const char *s_orig = s;
  ((s != ((void *)0)) ? (void) (0) : __assert_fail ("s != NULL", "od.c", 984, __PRETTY_FUNCTION__));
  ...
  while (*s != '\0')
    {
      ...
      ((s != next) ? (void) (0) : __assert_fail ("s != next", "od.c", 996, __PRETTY_FUNCTION__));
      s = next;
      ++n_specs;
    }
...
# 1034 "od.c"
  ...
  if (n_skip != 0)
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("cannot skip past end of combined input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("cannot skip past end of combined input")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
read_block (size_t n, char *block, size_t *n_bytes_in_buffer)
{
  ...
  ((0 < n && n <= bytes_per_block) ? (void) (0) : __assert_fail ("0 < n && n <= bytes_per_block", "od.c", 1288, __PRETTY_FUNCTION__));
      ...
      while (1)
        {
          ...
          if (n_bytes_read < bytes_per_block)
            break;
          ((n_bytes_read == bytes_per_block) ? (void) (0) : __assert_fail ("n_bytes_read == bytes_per_block", "od.c", 1398, __PRETTY_FUNCTION__));
      ...
      while (1)
        {
          ...
          if (n_bytes_read < bytes_per_block)
            break;
          ((n_bytes_read == bytes_per_block) ? (void) (0) : __assert_fail ("n_bytes_read == bytes_per_block", "od.c", 1412, __PRETTY_FUNCTION__));
          write_block (current_offset, n_bytes_read,
                       block[!idx], block[idx]);
          current_offset += n_bytes_read;
          idx = !idx;
...
main (int argc, char **argv)
{
  ...
  fwrite_unlocked (input_data,sizeof(input_data),1,f);
  rpl_fclose(f);
        ...
        case 'S':
          ...
          if (optarg == ((void *)0))
          ...
          else
            {
              ...
              if ((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1) < tmp)
                ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s is too large"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s is too large"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
# 1755 "od.c"
        ...
        case 'w':
          ...
          if (optarg == ((void *)0))
          ...
          else
            {
              ...
              if (s_err != LONGINT_OK)
                xstrtol_fatal (s_err, oi, c, long_options, optarg);
              if ((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1) < w_tmp)
                ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s is too large"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s is too large"), quote (optarg)), ((0) ? (void) 0 : __builtin_unreachable ()))));
              desired_width = w_tmp;
            }
          break;
  ...
  if (flag_dump_strings && n_specs > 0)
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("no type may be specified when dumping strings")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("no type may be specified when dumping strings")), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                            ;
  ...
  if (limit_bytes_to_format)
    {
      ...
      if (end_offset < n_bytes_to_skip)
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("skip-bytes + read-bytes is too large")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("skip-bytes + read-bytes is too large")), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
...
cleanup:
  ...
  if (have_read_stdin && rpl_fclose (stdin) == (-1))
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), gettext ("standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))));
