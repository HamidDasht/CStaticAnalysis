...
# 25 "comm.c" 2
# 1 "../../../coreutils-8.30/lib/linebuffer.h" 1
# 22 "../../../coreutils-8.30/lib/linebuffer.h"
# 1 "../../../coreutils-8.30/lib/stdio.h" 1
# 20 "../../../coreutils-8.30/lib/stdio.h"
       
# 21 "../../../coreutils-8.30/lib/stdio.h" 3
# 23 "../../../coreutils-8.30/lib/linebuffer.h" 2
...
# 32 "comm.c" 2
# 1 "../../../coreutils-8.30/lib/memcmp2.h" 1
# 20 "../../../coreutils-8.30/lib/memcmp2.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 21 "../../../coreutils-8.30/lib/memcmp2.h" 2
...
main (int argc, char **argv)
{
  ...
  FILE* f = fopen_safer("input_data_1", "w");
  fputs_unlocked (input_data_1,f);
  rpl_fclose(f);
  f = fopen_safer("input_data_2","w");
  fputs_unlocked (input_data_2,f);
  rpl_fclose(f);
# 496 "comm.c"
  ;
    ...
    switch (c)
      ...
      case OUTPUT_DELIMITER_OPTION:
        if (col_sep_len && !(strcmp (col_sep, optarg) == 0))
          ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("multiple output delimiters specified")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("multiple output delimiters specified")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        col_sep = optarg;
