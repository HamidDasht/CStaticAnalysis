...
# 1 "../../../coreutils-8.30/lib/base32.h" 1
# 22 "../../../coreutils-8.30/lib/base32.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 23 "../../../coreutils-8.30/lib/base32.h" 2
...
# 105 "./base32.c"
extern int (*_gl_verify_function2 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: ((1024*3*10) % 40 == 0) ? 1 : -1; }))];
extern int (*_gl_verify_function3 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: ((1024*5) % 40 == 0) ? 1 : -1; }))];
# 130 "./base32.c"
static void
  ...
  if (wrap_column == 0)
    {
      ...
      if (fwrite_unlocked (buffer,1,len,stdout) < len)
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
  else
    for (written = 0; written < len;)
      {
        uintmax_t cols_remaining = wrap_column - *current_column;
        size_t to_write = (((cols_remaining)<((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1)))?(cols_remaining):((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1)));
...
do_encode (FILE *in, FILE *out, uintmax_t wrap_column)
{
  ...
  if (ferror_unlocked (in))
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), gettext ("read error")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("read error")), ((0) ? (void) 0 : __builtin_unreachable ()))));
}
      ...
      for (k = 0; k < 1 + !!feof_unlocked (in); k++)
        {
          ...
          if (!ok)
            ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("invalid input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid input")), ((0) ? (void) 0 : __builtin_unreachable ()))));
        }
    }
...
# 328 "./base32.c"
  ...
  while ((opt = getopt_long (argc, argv, "diw:", long_options, ((void *)0))) != -1)
    switch (opt)
      ...
      case 'w':
        wrap_column = xdectoumax (optarg, 0, (18446744073709551615UL), "",
      ...
      case GETOPT_VERSION_CHAR: version_etc (stdout, "base32", "GNU coreutils", Version, ("Simon Josefsson"), (char *) ((void *)0)); exit (0); break;;
  ...
  if (rpl_fclose (input_fh) == (-1))
    {
      if ((strcmp (infile, "-") == 0))
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), gettext ("closing standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("closing standard input")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      else
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "%s", quotearg_n_style_colon (0, shell_escape_quoting_style, infile)), ((0) ? (void) 0 : __builtin_unreachable ()))));
    }
