...
print_factors (const char *input)
{
  ...
  // Instrument
  //CREST_unsigned_int(t0);
  //CREST_unsigned_int(t1);
...
main (int argc, char **argv)
{
  ...
  char temp[40];
  unsigned int crest_input_1 = 10;
  unsigned int crest_input_2 = 10; 
  char *bufcha;
  char char_c;
  bufcha = malloc(sizeof(char)*10);
