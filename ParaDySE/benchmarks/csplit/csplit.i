...
# 1 "../../../coreutils-8.30/lib/regex.h" 1
# 24 "../../../coreutils-8.30/lib/regex.h"
# 1 "../../../coreutils-8.30/lib/sys/types.h" 1
# 20 "../../../coreutils-8.30/lib/sys/types.h"
       
# 21 "../../../coreutils-8.30/lib/sys/types.h" 3
# 25 "../../../coreutils-8.30/lib/regex.h" 2
...
# 347 "../../../coreutils-8.30/lib/regex.h"
typedef enum
{
  _REG_ENOSYS = -1,
  _REG_NOERROR = 0,
...
# 458 "../../../coreutils-8.30/lib/regex.h"
...
# 518 "../../../coreutils-8.30/lib/regex.h"
typedef struct
{
  regoff_t rm_so;
  regoff_t rm_eo;
...
extern regoff_t re_match_2 (struct re_pattern_buffer *__buffer,
       ...
       regoff_t __start, struct re_registers *__regs,
       regoff_t __stop);
# 597 "../../../coreutils-8.30/lib/regex.h"
extern void re_set_registers (struct re_pattern_buffer *__buffer,
         struct re_registers *__regs,
         __re_size_t __num_regs,
         regoff_t *__starts, regoff_t *__ends);
# 640 "../../../coreutils-8.30/lib/regex.h"
...
# 1 "../../../coreutils-8.30/lib/fd-reopen.h" 1
# 20 "../../../coreutils-8.30/lib/fd-reopen.h"
# 1 "../../../coreutils-8.30/lib/sys/types.h" 1
# 20 "../../../coreutils-8.30/lib/sys/types.h"
       
# 21 "../../../coreutils-8.30/lib/sys/types.h" 3
# 21 "../../../coreutils-8.30/lib/fd-reopen.h" 2
...
# 36 "csplit.c" 2
# 1 "../../../coreutils-8.30/lib/safe-read.h" 1
# 30 "../../../coreutils-8.30/lib/safe-read.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 31 "../../../coreutils-8.30/lib/safe-read.h" 2
...
# 21 "../../../coreutils-8.30/lib/stdio.h" 3
# 21 "../../../coreutils-8.30/lib/stdio--.h" 2
# 1 "../../../coreutils-8.30/lib/stdio-safer.h" 1
# 20 "../../../coreutils-8.30/lib/stdio-safer.h"
# 1 "../../../coreutils-8.30/lib/stdio.h" 1
# 20 "../../../coreutils-8.30/lib/stdio.h"
       
# 21 "../../../coreutils-8.30/lib/stdio.h" 3
# 21 "../../../coreutils-8.30/lib/stdio-safer.h" 2
...
# 22 "../../../coreutils-8.30/lib/stdio--.h" 2
# 38 "csplit.c" 2
# 1 "../../../coreutils-8.30/lib/xdectoint.h" 1
# 21 "../../../coreutils-8.30/lib/xdectoint.h"
# 1 "../../../coreutils-8.30/lib/inttypes.h" 1
# 25 "../../../coreutils-8.30/lib/inttypes.h"
       
# 26 "../../../coreutils-8.30/lib/inttypes.h" 3
# 22 "../../../coreutils-8.30/lib/xdectoint.h" 2
  ...
  while (1)
    {
      ...
      if (((size_t) ((((((0l) + 1) << ((64) ? (64) - 1 - (1) : 0)) - 1) * 2 + 1) < (((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1) ? (((((0l) + 1) << ((64) ? (64) - 1 - (1) : 0)) - 1) * 2 + 1) : (((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1) - 1) / (b->bytes_alloc) < (2)))
        xalloc_die ();
...
get_first_line_in_buffer (void)
{
  if (head == ((void *)0) && !load_buffer ())
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), gettext ("input disappeared")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), gettext ("input disappeared")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
find_line (uintmax_t linenum)
{
  ...
  for (b = head;;)
    {
      ((b) ? (void) (0) : __assert_fail ("b", "csplit.c", 619, __PRETTY_FUNCTION__));
...
check_for_offset (struct control *p, const char *str, const char *num)
{
  if (xstrtoimax (num, ((void *)0), 10, &p->offset, "") != LONGINT_OK)
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s: integer expected after delimiter"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: integer expected after delimiter"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))))
                     ;
}
...
parse_repeat_count (int argnum, struct control *p, char *str)
{
  ...
  if (*end != '}')
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s: '}' is required in repeat count"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: '}' is required in repeat count"), quote (str)), ((0) ? (void) 0 : __builtin_unreachable ()))))
                     ;
  *end = '\0';
  ...
  if (str+1 == end-1 && *(str+1) == '*')
  ...
  else
    {
      if (xstrtoumax (str + 1, ((void *)0), 10, &val, "") != LONGINT_OK)
        {
          ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s}: integer required between '{' and '}'"), quote (global_argv[argnum])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s}: integer required between '{' and '}'"), quote (global_argv[argnum])), ((0) ? (void) 0 : __builtin_unreachable ()))))
...
extract_regexp (int argnum, _Bool ignore, char const *str)
{
  ...
  if (closing_delim == ((void *)0))
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s: closing delimiter '%c' missing"), str, delim), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: closing delimiter '%c' missing"), str, delim), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                             ;
      ...
      if (*argv[i] == '/' || *argv[i] == '%')
      ...
      else
        {
          ...
          if (xstrtoumax (argv[i], ((void *)0), 10, &val, "") != LONGINT_OK)
            ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s: invalid pattern"), quote (argv[i])), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: invalid pattern"), quote (argv[i])), ((0) ? (void) 0 : __builtin_unreachable ()))));
          if (val == 0)
            ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%s: line number must be greater than zero"), argv[i]), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%s: line number must be greater than zero"), argv[i]), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                                         ;
          if (val < last_val)
            {
              char buf[((((((sizeof (uintmax_t) * 8) - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + 1)];
              ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("line number %s is smaller than preceding line number, %s"), quote (argv[i]), umaxtostr (last_val, buf)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("line number %s is smaller than preceding line number, %s"), quote (argv[i]), umaxtostr (last_val, buf)), ((0) ? (void) 0 : __builtin_unreachable ()))))
...
check_format_conv_type (char *format, int flags)
{
  ...
  switch (ch)
    ...
    case 0:
      ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("missing conversion specifier in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("missing conversion specifier in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))));

    default:
      if (((*__ctype_b_loc ())[(int) ((ch))] & (unsigned short int) _ISprint))
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("invalid conversion specifier in suffix: %c"), ch), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid conversion specifier in suffix: %c"), ch), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                                 ;
      else
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("invalid conversion specifier in suffix: \\%.3o"), ch), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid conversion specifier in suffix: \\%.3o"), ch), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                                     ;
    }

  if (flags & ~ compatible_flags)
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("invalid flags in conversion specification: %%%c%c"), (flags & ~ compatible_flags & FLAG_ALTERNATIVE ? '#' : '\''), ch), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid flags in conversion specification: %%%c%c"), (flags & ~ compatible_flags & FLAG_ALTERNATIVE ? '#' : '\''), ch), ((0) ? (void) 0 : __builtin_unreachable ()))))
...
max_out (char *format)
{
  ...
  for (char *f = format; *f; f++)
    if (*f == '%' && *++f != '%')
      {
        if (percent)
          ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("too many %% conversion specifications in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("too many %% conversion specifications in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                                    ;
        percent = 1;
        int flags;
  ...
  if (! percent)
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("missing %% conversion specification in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("missing %% conversion specification in suffix")), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                                            ;

  int maxlen = snprintf (((void *)0), 0, format, (2147483647 * 2U + 1U));
  if (! (0 <= maxlen && maxlen <= (((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1)))
    xalloc_die ();
  return maxlen;
}
...
main (int argc, char **argv)
{
  ...
  FILE* f = fopen_safer("input_data", "w");
  ...
  while ((optc = getopt_long (argc, argv, "f:b:kn:sqz", longopts, ((void *)0))) != -1)
    switch (optc)
      ...
      case 'n':
        digits = xdectoimax (optarg, 0, (((2147483647)<((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1)))?(2147483647):((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1))), "",
  ...
  if ((((((0ul) + 1) << ((64) ? (64) - 1 - (0) : 0)) - 1) * 2 + 1) - 1 - prefix_len < max_digit_string_len)
    xalloc_die ();
