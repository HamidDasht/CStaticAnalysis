...
#define IN_FILE1 "input_file1"
#define IN_FILE2 "input_file2"
#define IN_FILE3 "input_file3"
#define MAX_DATA 500
...
main (int argc, char **argv)
{
  ...
  // Instrument optional args
  char s_opt;
  CREST_char(s_opt);
  sprintf(argv[2], "%c", s_opt);
