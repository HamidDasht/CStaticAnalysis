...
add_range_pair (uintmax_t lo, uintmax_t hi)
{
  if (n_frp == n_frp_allocated)
    frp = ((void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof *(frp) != 1) ? 1 : -1; })), x2nrealloc (frp, &n_frp_allocated, sizeof *(frp)));
  frp[n_frp].lo = lo;
  frp[n_frp].hi = hi;
  ++n_frp;
}
  ...
  while (1)
    {
      if (*fieldstr == '-')
      ...
      else if (((unsigned int) (*fieldstr) - '0' <= 9))
        {
          ...
          if (!( (void) (&(value) == (uintmax_t *) ((void *)0)), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (! (! ((uintmax_t) 0 < (uintmax_t) -1))) ? 1 : -1; })), (void) (!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (value) == sizeof (uintmax_t)) ? 1 : -1; })), (((uintmax_t) -1 / 10 < (value) || (uintmax_t) ((value) * 10 + (*fieldstr - '0')) < (value)) ? 0 : (((value) = (value) * 10 + (*fieldstr - '0')), 1)) )
