...
# 59 "printf.c" 2
# 1 "../../../../coreutils-8.30/lib/c-strtod.h" 1
# 40 "../../../../coreutils-8.30/lib/c-strtod.h"
...
# 63 "printf.c" 2
# 1 "../../../../coreutils-8.30/lib/unicodeio.h" 1
# 21 "../../../../coreutils-8.30/lib/unicodeio.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 22 "../../../../coreutils-8.30/lib/unicodeio.h" 2
# 1 "../../../../coreutils-8.30/lib/stdio.h" 1
# 20 "../../../../coreutils-8.30/lib/stdio.h"
       
# 21 "../../../../coreutils-8.30/lib/stdio.h" 3
# 23 "../../../../coreutils-8.30/lib/unicodeio.h" 2
  ...
  if (*p == 'x')
    {
      ...
      if (esc_length == 0)
        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("missing hexadecimal number in escape")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("missing hexadecimal number in escape")), ((0) ? (void) 0 : __builtin_unreachable ()))));
      ...
      switch (*f)
        ...
        no_more_flag_characters:
              ...
              if (argc > 0)
                {
                  ...
                  if ((-2147483647 - 1) <= width && width <= 2147483647)
                    ...
                    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("invalid field width: %s"), quote (*argv)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid field width: %s"), quote (*argv)), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                       ;
                  ++argv;
                  --argc;
                }
                  ...
                  if (argc > 0)
                    {
                      ...
                      if (prec < 0)
                        ...
                        ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("invalid precision: %s"), quote (*argv)), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("invalid precision: %s"), quote (*argv)), ((0) ? (void) 0 : __builtin_unreachable ()))))
                                           ;
                      else
                        precision = prec;
                      ++argv;
...

          {
            ...
            if (! ok[conversion])
              ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, 0, gettext ("%.*s: invalid conversion specification"), (int) (f + 1 - direc_start), direc_start), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, 0, gettext ("%.*s: invalid conversion specification"), (int) (f + 1 - direc_start), direc_start), ((0) ? (void) 0 : __builtin_unreachable ()))))
