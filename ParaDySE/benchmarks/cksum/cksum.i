...
extern int getopt_long_only (int ___argc, char *const *___argv,
       ...
       __attribute__ ((__nothrow__ , __leaf__));
# 111 "cksum.c" 2
# 1 "../../../coreutils-8.30/lib/long-options.h" 1
...
cksum (const char *file, _Bool print_name)
{
  ...
  if (ferror_unlocked (stdout))
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), "-: %s", gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "-: %s", gettext ("write error")), ((0) ? (void) 0 : __builtin_unreachable ()))));
...
main (void)
{
  ...
  FILE* input_fh = fopen("crest_data", "w");
  ...
  if (getopt_long (argc, argv, "", long_options, ((void *)0)) != -1)
    usage (1);
  ...
  if (have_read_stdin && rpl_fclose (stdin) == (-1))
    ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (1) ? 1 : -1; })) ? ((error (1, (*__errno_location ()), "-"), ((0) ? (void) 0 : __builtin_unreachable ()))) : ((error (1, (*__errno_location ()), "-"), ((0) ? (void) 0 : __builtin_unreachable ()))));
  return ok ? 0 : 1;
}
