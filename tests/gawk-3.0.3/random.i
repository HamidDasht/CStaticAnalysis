...
static int seps[ 5 ] = { 0, 3, 1,
        3, 1 };
# 128 "random.c"
static long randtbl[ 31 + 1 ] = { 3,
...
static long *end_ptr = &randtbl[ 31 + 1 ];
# 198 "random.c"
void
gawk_srandom( x )
    ...
    unsigned x;
{
 ...
 if( rand_type == 0 ) {
  ...
  state[i] = 1103515245*state[i - 1] + 12345;
     ...
     fptr = &state[ rand_sep ];
     rptr = &state[ 0 ];
     for( i = 0; i < 10*rand_deg; i++ ) gawk_random();
 }
}
# 239 "random.c"
char *
gawk_initstate( seed, arg_state, n )
    ...
    int n;
{
 ...
 if( rand_type == 0 ) state[ -1 ] = rand_type;
