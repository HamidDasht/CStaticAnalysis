...
# 27 "./gawkmisc.c" 2
# 39 "./gawkmisc.c"
# 1 "./posix/gawkmisc.c" 1
# 19 "./posix/gawkmisc.c"
char quote = '\'';
char *defpath = ".:/usr/local/share/awk";
char envsep = ':';
...
# 80 "./posix/gawkmisc.c"
 if (isatty(fd))
  return 
# 81 "./posix/gawkmisc.c" 3 4
        8192
# 81 "./posix/gawkmisc.c"
              ;
 if (fstat(fd, stb) == -1)
  set_loc("./posix/gawkmisc.c", 83), r_fatal("can't stat fd %d (%s)", fd, strerror(
# 83 "./posix/gawkmisc.c" 3 4
                                             (*__errno_location ())
# 83 "./posix/gawkmisc.c"
                                                  ));
 if (lseek(fd, (off_t)0, 0) == -1)
  return (stb->st_blksize ? stb->st_blksize : 
# 85 "./posix/gawkmisc.c" 3 4
        8192
# 85 "./posix/gawkmisc.c"
        );
 if (stb->st_size > 0 && stb->st_size < (stb->st_blksize ? stb->st_blksize : 
# 86 "./posix/gawkmisc.c" 3 4
                                       8192
# 86 "./posix/gawkmisc.c"
                                       ))
  return stb->st_size;
 return (stb->st_blksize ? stb->st_blksize : 
# 88 "./posix/gawkmisc.c" 3 4
       8192
# 88 "./posix/gawkmisc.c"
       );
}
...
extern pointer xmalloc (size_t bytes);
...
size_t bytes;
{
 ...
 (void)((p=(pointer)malloc((size_t)(bytes))) || (set_loc("./gawkmisc.c", 60), r_fatal("%s: %s: can't allocate memory (%s)", ("xmalloc"), "p", strerror(
# 60 "./gawkmisc.c" 3 4
(*__errno_location ())
# 60 "./gawkmisc.c"
)),0));
