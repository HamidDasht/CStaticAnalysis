...
# 556 "dfa.c" 3 4
  5
# 556 "dfa.c"
  )); else return lasttok = END; (c) = (unsigned char) *lexptr++; --lexleft; };
   if (
# 557 "dfa.c" 3 4
      ((*__ctype_b_loc ())[(int) ((
# 557 "dfa.c"
...
# 682 "dfa.c" 3 4
       5
# 682 "dfa.c"
       )); else return lasttok = END; (c1) = (unsigned char) *lexptr++; --lexleft; };
        goto skip;
      }
...
# 690 "dfa.c" 3 4
   5
# 690 "dfa.c"
   )); else return lasttok = END; (c2) = (unsigned char) *lexptr++; --lexleft; };
    if (c2 == ']')
      {
